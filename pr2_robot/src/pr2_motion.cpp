    ...
    left_gripper_group(LEFT_GRIPPER_GROUP)
{
  ...
  bool right_success = (right_move_group.move()==1);
  bool left_success = (left_move_group.move()==1);
  ...
  for(size_t i=0; i<pose_list.size();++i)
  {
    ...
    right_success = (right_move_group.plan(right_arm_plan)==1);
  ...
  right_move_group.setNamedTarget("RIGHT_ARM_INITIAL_POSE");
  left_move_group.setNamedTarget("LEFT_ARM_INITIAL_POSE");
  right_success = (right_move_group.move()==1);
  left_success = (left_move_group.move()==1);
}
...
bool PR2Motion::OperateRightGripper(const bool &close_gripper)
{
  ...
  bool success = (right_gripper_group.move()==1);
  return success;
}
...
bool PR2Motion::OperateLeftGripper(const bool &close_gripper)
{
  ...
  bool success = (left_gripper_group.move()==1);
  return success;
}
